    ...
    <div className=" bg-liter-orange relative h-auto radius-hero overflow-hidden">
      <div className="my-container flex flex-col lg:flex-row">
        <div className=" w-full lg:w-1/2 items-center pt-10 lg:pt-16 lg:pb-24">
          <h1 className=" text-4xl md:text-5xl lg:text-6xl font-medium text-my-blue">
            Build Your Future <br />
            with <span className=" font-semibold text-my-orange">Uniguru!</span>
          </h1>
          ...
          <div className=" mt-10 flex gap-4">
            ...
            <Link
              href={"/about-us"}
              className=" flex items-center hover:font-semibold text-my-black text-nowrap"
            >
              Learn More
            </Link>
          </div>
