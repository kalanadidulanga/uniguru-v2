...
export const NAVBAR_DATA = [
  ...
  },
  {
    ...
    subOptions: [
      { name: "The UK", link: "/study-destinations/uk" },
      { name: "Canada", link: "/study-destinations/canada" },
      { name: "Australia", link: "/study-destinations/australia" },
      { name: "Netherlands", link: "/study-destinations/netherlands" },
      { name: "Germany", link: "/study-destinations/germany" },
    ],
  },
  {
    name: "Services",
